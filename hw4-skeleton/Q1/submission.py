...
def author():                                                                                             
        return "zpatwary3" # replace gburdell3 with your Georgia Tech username.
                                                                                              
def gtid():                                                                                               
    return 903282505 # replace with your GT ID number
...
class PageRank:
    ...
    def calculate_node_degree(self):
        ...
        #############################################
            pass
            val = self.node_degree.get(source, 0) + 1
            self.node_degree[source] = val
